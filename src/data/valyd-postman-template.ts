...
export const postmanTemplate = {
  ...
  item: [
    ...
    },
    {
      ...
      request: {
        ...
        description: "Get user profile and identity fields for the bearer `access_token`.\n\nTypical fields: `sub` (subject ID), `email`, `first_name`, `last_name`, `full_name`, `anon_id`, `id_verified`, `created_at`.\n"
      },
      response: [
        {
          name: "200 OK",
  ...
  variable: [
    { key: "base_url", value: API_CONFIG.API_BASE_URL },
    { key: "client_id", value: "" },
...
export type PostmanCollection = typeof postmanTemplate;
